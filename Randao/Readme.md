...
11. getRandom: After the reveal phase is over (after `20`), consumer can get the random number generated. Expected: [Success]`31581345179634135967651132776678317366390452936495181389759623311064980503249`. Event: `RandomNumber`.
